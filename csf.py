...
def contractible(path, perm, composition):
    ...
    >>> any(contractible((2, 1, 0), perm, (2, 1))
    ...     for perm in it.permutations(range(3)))
    False
    >>> contractible((1, 1, 0), (0, 1, 2), (2, 1))
    False
    >>> contractible((1, 1, 0), (0, 2, 1), (2, 1))
    True
    >>> contractible((1, 1, 0), (1, 0, 2), (2, 1))
    False
    >>> contractible((1, 1, 0), (1, 2, 0), (2, 1))
    False
    >>> contractible((1, 1, 0), (2, 0, 1), (2, 1))
    False
    >>> contractible((1, 1, 0), (2, 1, 0), (2, 1))
    False
    >>> contractible((0, 0, 0), (0, 1, 2), (3,))
    True
    >>> contractible((0, 0, 0), (0, 2, 1), (3,))
    False
    >>> contractible((0, 0, 0), (1, 0, 2), (3,))
    False
    >>> contractible((0, 0, 0), (1, 2, 0), (3,))
    False
    >>> contractible((0, 0, 0), (2, 0, 1), (3,))
    False
    >>> contractible((0, 0, 0), (2, 1, 0), (3,))
    False
    """
    n = len(path)
