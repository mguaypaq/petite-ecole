...
from dyckpath import boxes_under_path
...
def inversions(path, perm):
    ...
    >>> inversions((2, 1, 0), (0, 1, 2))
    0
    >>> inversions((2, 1, 0), (0, 2, 1))
    1
    >>> inversions((2, 1, 0), (1, 0, 2))
    1
    >>> inversions((2, 1, 0), (1, 2, 0))
    2
    >>> inversions((2, 1, 0), (2, 0, 1))
    2
    >>> inversions((2, 1, 0), (2, 1, 0))
    3
    >>> inversions((1, 1, 0), (0, 1, 2))
    0
    >>> inversions((1, 1, 0), (0, 2, 1))
    1
    >>> inversions((1, 1, 0), (1, 0, 2))
    1
    >>> inversions((1, 1, 0), (1, 2, 0))
    1
    >>> inversions((1, 1, 0), (2, 0, 1))
    1
    >>> inversions((1, 1, 0), (2, 1, 0))
    2
    """
